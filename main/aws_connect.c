...
{ 
   ...
   /*Initialize a new MQTT client context. This function should be called before any 
    ...
    {
        .url = "https://api.tomtom.com/traffic/services/4/flowSegmentData/absolute/10/json?point=48.791672%2C2.344767&unit=KMPH&key=1Nah1nT5bQ8YmEZi79SSVEJcAHcp2Ucz",
